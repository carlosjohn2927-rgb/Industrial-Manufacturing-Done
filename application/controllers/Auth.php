...
class Auth extends MY_Controller
{
    ...
    public function login()
    {
        ...
        $this->page_description = 'Sign in to your ' . ($this->config->item('site_name') ?: 'Vortex Precision IT') . ' account.';
    ...
    public function register()
    {
        ...
        $this->page_description = 'Create a ' . ($this->config->item('site_name') ?: 'Vortex Precision IT') . ' account to manage quotes and downloads.';
        ...
        if ($this->input->method() === 'post') {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($user && $user['isActive']) {
                    ...
                    $this->mailer->send(
                        $user['email'],
                        'Reset your ' . ($this->config->item('site_name') ?: 'Vortex Precision IT') . ' password',
    ...
    public function reset($token = null)
    {
        ...
        $this->page_description = 'Choose a new password for your ' . ($this->config->item('site_name') ?: 'Vortex Precision IT') . ' account.';
