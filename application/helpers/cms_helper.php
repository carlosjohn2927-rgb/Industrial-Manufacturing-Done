...
if (!function_exists('vp_theme_style_tag')) {
    ...
    function vp_theme_style_tag()
    {
        ...
        return '<style id="vp-theme">'
            ...
            . '.vp-writeup-overlay{background-color:rgba(255,255,255,0.10)!important;box-shadow:none!important;}'
            ...
            . 'section.vp-writeup-band a.bg-brand-500,section.vp-writeup-band a.bg-brand-600,'
            . 'section.vp-writeup-band a.bg-brand-700,section.vp-writeup-band .vp-btn-primary,'
            . 'section.vp-writeup-band .vp-cta-quote{color:#000000!important;}'
