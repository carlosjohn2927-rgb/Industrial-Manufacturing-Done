...
-- 4. CATEGORIES
-- #############################################################################
INSERT INTO `categories` (`id`,`name`,`slug`,`description`,`icon`,`image`,`sortOrder`,`isActive`,`metaTitle`) VALUES
(UUID(),'Valves','valves','Industrial valves for flow control in demanding applications.','valve','/assets/img/products/valves.jpg', 1,1,'Industrial Valves - Vortex Precision IT'),
(UUID(),'Pumps','pumps','Centrifugal, positive displacement and specialty pumps.','pump','/assets/img/products/pumps.jpg', 2,1,'Industrial Pumps - Vortex Precision IT'),
(UUID(),'Heat Exchangers','heat-exchangers','Shell-and-tube, plate and brazed heat exchangers.','heater','/assets/img/products/heat-exchangers.jpg', 3,1,'Heat Exchangers - Vortex Precision IT'),
(UUID(),'Pressure Vessels','pressure-vessels','ASME-coded pressure vessels for process industries.','vessel','/assets/img/products/pressure-vessels.jpg', 4,1,'Pressure Vessels - Vortex Precision IT'),
(UUID(),'Filtration','filtration','Industrial filtration systems and cartridges.','filter','/assets/img/products/filtration.jpg', 5,1,'Filtration Systems - Vortex Precision IT'),
(UUID(),'Instrumentation','instrumentation','Process measurement, gauges and sensors.','gauge','/assets/img/products/instrumentation.jpg', 6,1,'Instrumentation - Vortex Precision IT');
...
-- =============================================================================
-- AJR NDT Product Range (migration 010)
-- 13 Categories, 93 Precision Testing Products, Images & Specifications
-- =============================================================================
-- =============================================================================
